        ...
        <a href="{{ route('category') }}"
         ...
         <!-- <div>
            <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider"
                class=" w-full text-white hover:bg-gray-300   font-medium rounded text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                type="button">
                Dropdown
            ...
            <div id="dropdownDivider"
                class="z-10 hidden  divide-y divide-gray-100 rounded  w-full dark:bg-gray-700 dark:divide-gray-600">
