<div>
    <div class="container mt-10 mx-auto flex justify-between">
        <div class="flex justify-between">
            ...
            <p class="text-2xl font-semibold leading-tight mb-5 ml-1">
                Prodect Index
            </p>
        </div>
        <a href="{{ route('addprodect') }} ">
            <button type="button"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded text-sm px-6 py-2 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                Creat New</button>
        </a>
    </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 border border-gray-200 mt-4 ">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr class="text-right border border-gray-200">
                            <th class="p-4 text-left border border-gray-200 bg-gray-100">No</th>
                            <th class="p-4 text-left border border-gray-200">Photo</th>
                            <th class="p-4 text-left border border-gray-200">Product</th>
                            <th class="p-4 text-left border border-gray-200">Code</th>
                            <!-- <th class="p-4 text-left border border-gray-200">Category</th> -->
                            <th class="p-4 text-left border border-gray-200">Selling Price</th>
                            <th class="p-4 text-left border border-gray-200">Action</th>
                    ...
                    <tbody>
                        ...
                        <tr class="text-right border-b border-opacity-20 dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <td class="px-3 py-2 text-left border border-gray-200 bg-gray-100">
