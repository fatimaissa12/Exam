...
<body class="font-sans antialiased">
    <div class="flex" x-data="{isOpen:true}">
        <div class="relative h-screen md-flex">
            <aside :class="isOpen?'w-64':'w-0'"
                class=" z-10 bg-blue-800 text-white  py-4 absolute inset-y-0 left-0  md-relative transform md:translate-x-0 overflow-y-auto transition ease-in-out duration-200">
                <div class=" flex justify-end ">
                    <button @click.prevent="isOpen = !isOpen"
                        class="md:hidden inline-flex p-2 item-center justify-center rounded-md text-blue-100 focus:outline-none">
                        x
                    </button>
                </div>
                <div class="grid justify-items-center pl-1.5 mb-5 ">
                    ...
                    <div class="bg-local  w-full h-20 bg-cover bg-center "
                        style="background-image: url({{ asset('/images/photo.jpg') }})">
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="#"
                            ...
                            <svg class="w-6 h-6 text-red-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="body" class="w-full h-screen overflow-y-auto bg-gray-500">
            <button type="button" @click.prevent="isOpen = !isOpen" class="w-full h-auto p-4 flex justify-end">
