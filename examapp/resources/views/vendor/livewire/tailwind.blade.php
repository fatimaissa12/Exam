<div>
    ...
    @if ($paginator->hasPages())
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center rounded-none justify-between">
            <div class="flex justify-between flex-1 sm:hidden rounded-none">
                <span>
                    @if ($paginator->onFirstPage())
                        <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-none select-none">
                ...
                <span>
                    ...
                    @else
                        <span class="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-none select-none">
                            {!! __('pagination.next') !!}
                        </span>
                    @endif
                </span>
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center rounded-none sm:justify-between">
                <div>
                ...
                <div>
                    <span class="relative z-0 inline-flex rounded-none shadow-sm">
                        <span>
                            {{-- Previous Page Link --}}
                            @if ($paginator->onFirstPage())
                                <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                                    <span class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-none leading-5" aria-hidden="true">
